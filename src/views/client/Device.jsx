        ...
        return () => (
            <>
                <button 
                  ...
                  style={{ position: 'fixed', bottom: '28px', right: '28px', width: '60px', height: '60px', borderRadius: '50%', backgroundColor: '#ffffff', border: 'none', cursor: 'pointer', fontSize: '24px', zIndex: 10000, boxShadow: '0 4px 20px rgba(255,255,255,0.1)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                >
                    {isOpen.value ? '✕' : '💬'}
                </button>
                {isOpen.value && (
