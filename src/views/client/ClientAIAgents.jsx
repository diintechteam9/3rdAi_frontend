  ...
  setup() {
    ...
    const loadAgents = async () => {
      ...
      try {
        ...
        console.error('Failed to load client agents', e);
    ...
    const onDelete = async (agent) => {
      ...
      success.value = null;
      try {
        await api.delete(`/client/agents/${agent._id}`);
    ...
    const onSubmit = async (evt) => {
      ...
      try {
        if (editingId.value) {
          await api.put(`/client/agents/${editingId.value}`, payload);
          success.value = 'Agent updated successfully';
        } else {
          await api.post('/client/agents', payload);
                ...
                <form onSubmit={onSubmit}>
                  ...
                  <div class="mb-3">
                    ...
                    <textarea
                      class="form-control"
                      rows="4"
                      placeholder="How this agent should behave for this client"
                  ...
                  <div class="form-check form-switch mb-3">
                    <input
                      ...
                      type="checkbox"
                      id="client-agent-active-switch"
                      checked={form.isActive}
                      onChange={e => (form.isActive = e.target.checked)}
                    />
                    <label class="form-check-label" for="client-agent-active-switch">
                      Active (available to this client&apos;s users)
                    </label>
                  </div>
            ...
            <div class="card shadow-sm">
              <div class="card-body">
                ...
                {loading.value ? (
                  ...
                  <p class="text-muted mb-0">No agents created yet for this client.</p>
                ) : (
