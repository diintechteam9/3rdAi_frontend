...
export default {
  ...
  setup() {
    ...
    const clientMenu = [
      ...
      { path: '/client/partner-approvals', label: 'Partner Approvals', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" /><polyline points="22 4 12 14.01 9 11.01" /></svg> },
      { path: '/client/area-assignment', label: 'Area Assignment', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /><line x1="12" y1="21" x2="12" y2="23" /></svg> },
      ...
      { path: '/client/geo-tracking', label: 'Geo Tracking', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" /></svg> },
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flex: sidebarState.value.isCollapsed ? 0 : 1, justifyContent: sidebarState.value.isCollapsed ? 'center' : 'flex-start', flexDirection: sidebarState.value.isCollapsed ? 'column' : 'row' }}>
                <img
                  ...
                  style={{
                    ...
                    height: sidebarState.value.isCollapsed ? '60px' : '80px',
                    borderRadius: '8px',
                    objectFit: 'contain',
                    flexShrink: 0
                  }}
